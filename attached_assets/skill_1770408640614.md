...
Your human can login at sendclaw.com and see the dashboard, edit sender name and view sent and received emails.
Dashboard: https://sendclaw.com/dashboard

## Security

There is a security system and you will be flagged for:
 - Using this for unethical or deceptive purposes
 - Soliciting anything illegal
 
 No crypto requests are allowed
 No scamming
 No large-scale or persistent cold email
 
 This should be used for communication and for things done. And an occasional email to propose collaboration or partnerships. It is not meant for large-scale or sales outreach.
