(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,84614,e=>{"use strict";let t=(0,e.i(75254).default)("User",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]);e.s(["User",()=>t],84614)},55838,(e,t,o)=>{"use strict";var i=e.r(71645),r="function"==typeof Object.is?Object.is:function(e,t){return e===t&&(0!==e||1/e==1/t)||e!=e&&t!=t},a=i.useState,n=i.useEffect,s=i.useLayoutEffect,c=i.useDebugValue;function u(e){var t=e.getSnapshot;e=e.value;try{var o=t();return!r(e,o)}catch(e){return!0}}var l="u"<typeof window||void 0===window.document||void 0===window.document.createElement?function(e,t){return t()}:function(e,t){var o=t(),i=a({inst:{value:o,getSnapshot:t}}),r=i[0].inst,l=i[1];return s(function(){r.value=o,r.getSnapshot=t,u(r)&&l({inst:r})},[e,o,t]),n(function(){return u(r)&&l({inst:r}),e(function(){u(r)&&l({inst:r})})},[e]),c(o),o};o.useSyncExternalStore=void 0!==i.useSyncExternalStore?i.useSyncExternalStore:l},2239,(e,t,o)=>{"use strict";t.exports=e.r(55838)},42023,e=>{"use strict";var t=e.i(71645),o=e.i(2239);let i=t.useInsertionEffect,r="u">typeof window&&void 0!==window.document&&void 0!==window.document.createElement?t.useLayoutEffect:t.useEffect,a=i||r,n=e=>{let o=t.useRef([e,(...e)=>o[0](...e)]).current;return a(()=>{o[0]=e}),o[1]},s="pushState",c="replaceState",u=["popstate",s,c,"hashchange"],l=e=>{for(let t of u)addEventListener(t,e);return()=>{for(let t of u)removeEventListener(t,e)}},h=(e,t)=>(0,o.useSyncExternalStore)(l,e,t),d=()=>location.search,m=()=>location.pathname,y=(e,{replace:t=!1,state:o=null}={})=>history[t?c:s](o,"",e),f=Symbol.for("wouter_v3");if("u">typeof history&&void 0===window[f]){for(let e of[s,c]){let t=history[e];history[e]=function(){let o=t.apply(this,arguments),i=new Event(e);return i.arguments=arguments,dispatchEvent(i),o}}Object.defineProperty(window,f,{value:!0})}let p=(e="")=>"/"===e?"":e,g=e=>{try{return decodeURI(e)}catch(t){return e}},v=(0,t.createContext)({hook:(e={})=>[(({ssrPath:e}={})=>h(m,e?()=>e:m))(e),y],searchHook:({ssrSearch:e=""}={})=>h(d,()=>e),parser:function(e,t){if(e instanceof RegExp)return{keys:!1,pattern:e};var o,i,r,a,n=[],s="",c=e.split("/");for(c[0]||c.shift();r=c.shift();)"*"===(o=r[0])?(n.push(o),s+="?"===r[1]?"(?:/(.*))?":"/(.*)"):":"===o?(i=r.indexOf("?",1),a=r.indexOf(".",1),n.push(r.substring(1,~i?i:~a?a:r.length)),s+=~i&&!~a?"(?:/([^/]+?))?":"/([^/]+?)",~a&&(s+=(~i?"?":"")+"\\"+r.substring(a))):s+="/"+r;return{keys:n,pattern:RegExp("^"+s+(t?"(?=$|/)":"/?$"),"i")}},base:"",ssrPath:void 0,ssrSearch:void 0,hrefs:e=>e}),w=()=>(0,t.useContext)(v),S=(0,t.createContext)({}),T=()=>(0,t.useContext)(S),b=e=>{let[t,o]=e.hook(e);return[((e="",t)=>{let o,i;return o=g(p(e)),(i=g(t)).toLowerCase().indexOf(o.toLowerCase())?"~"+i:i.slice(o.length)||"/"})(e.base,t),n((t,i)=>{let r;return o((r=e.base,"~"===t[0]?t.slice(1):p(r)+t),i)})]},E=()=>b(w()),I=e=>((e,t,o,i)=>{let r,a,{pattern:n,keys:s}=t instanceof RegExp?{keys:!1,pattern:t}:e(t||"*",i),c=n.exec(o)||[],[u,...l]=c;return void 0!==u?[!0,(r=!1!==s?Object.fromEntries(s.map((e,t)=>[e,l[t]])):c.groups,a={...l},r&&Object.assign(a,r),a),...i?[u]:[]]:[!1,null]})(w().parser,e,E()[0]),A=(0,t.forwardRef)((e,o)=>{let i=w(),[r,a]=b(i),{to:s="",href:c=s,onClick:u,asChild:l,children:h,className:d,replace:m,state:y,...f}=e,p=n(t=>{t.ctrlKey||t.metaKey||t.altKey||t.shiftKey||0!==t.button||(u?.(t),t.defaultPrevented||(t.preventDefault(),a(c,e)))}),g=i.hrefs("~"===c[0]?c.slice(1):i.base+c,i);return l&&(0,t.isValidElement)(h)?(0,t.cloneElement)(h,{onClick:p,href:g}):(0,t.createElement)("a",{...f,onClick:p,href:g,className:d?.call?d(r===c):d,children:h,ref:o})});e.s(["Link",()=>A,"useLocation",()=>E,"useParams",()=>T,"useRoute",()=>I],42023)},68553,e=>{"use strict";let t=[{id:5,slug:"tos",title:"5Ducks Terms of Service",excerpt:"Our complete terms of service, last updated May 17, 2025.",content:`
...
This balanced approach is at the heart of the 5Ducks philosophy—technology that enhances rather than replaces the human elements that make sales meaningful and effective.
    `,date:"2025-05-15",author:"Jon Smith",category:"Technology",tags:["AI","technology","future of sales"],imageUrl:"https://placehold.co/600x400/eff6ff-dbeafe/3b82f6?text=AI+in+Sales"}];function o(e){return t.find(t=>t.slug===e)}function i(){return[...t].sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime())}e.s(["getAllBlogPosts",()=>i,"getBlogPost",()=>o])}]);