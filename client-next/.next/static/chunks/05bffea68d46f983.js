(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,68553,e=>{"use strict";let t=[{id:5,slug:"tos",title:"5Ducks Terms of Service",excerpt:"Our complete terms of service, last updated May 17, 2025.",content:`
...
This balanced approach is at the heart of the 5Ducks philosophy—technology that enhances rather than replaces the human elements that make sales meaningful and effective.
    `,date:"2025-05-15",author:"Jon Smith",category:"Technology",tags:["AI","technology","future of sales"],imageUrl:"https://placehold.co/600x400/eff6ff-dbeafe/3b82f6?text=AI+in+Sales"}];function o(e){return t.find(t=>t.slug===e)}function i(){return[...t].sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime())}e.s(["getAllBlogPosts",()=>i,"getBlogPost",()=>o])},32739,e=>{"use strict";var t=e.i(43476),o=e.i(4766),i=e.i(71645),a=e.i(68553);function r(){(0,i.useEffect)(()=>{window.scrollTo(0,0)},[]);let e=(0,a.getBlogPost)("privacy");return(0,t.jsx)("div",{className:"container mx-auto py-8 flex-1",children:(0,t.jsxs)(o.Card,{children:[(0,t.jsx)(o.CardHeader,{children:(0,t.jsx)(o.CardTitle,{children:"Privacy Policy"})}),(0,t.jsxs)(o.CardContent,{className:"prose prose-sm max-w-none",children:[(0,t.jsxs)("p",{className:"lead",children:["Last updated: ",e?.date||new Date().toLocaleDateString()]}),e?(0,t.jsx)("div",{dangerouslySetInnerHTML:{__html:e.content.replace(/^#+\s*5Ducks\s*Privacy\s*Policy\s*$/m,"").replace(/^\*\*Last\s*Updated:.*\*\*$/m,"").split("## ").join("<h2>").split("\n\n").join("</h2><p>").replace(/<h2>Introduction<\/h2>/g,"<h2>Introduction</h2>").replace(/<\/p>\s*<h2>/g,"</p><h2>").replace(/<p>-\s*/g,"<p>• ").replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\[([^\]]+)\]\(([^)]+)\)/g,'<a href="$2">$1</a>')}}):(0,t.jsx)("p",{children:"Privacy policy content not found. Please check the blog post data."})]})]})})}e.s(["default",()=>r])},6199,e=>{e.n(e.i(32739))}]);