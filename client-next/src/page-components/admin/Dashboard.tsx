      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          <TabsList>
            ...
            <TabsTrigger value="email" onClick={() => router.push('/admin/email')}>
              Email & Outreach
            </TabsTrigger>
            <TabsTrigger value="testing" onClick={() => router.push('/admin/testing')}>
              API Testing
            </TabsTrigger>
          </TabsList>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button 
                    onClick={() => router.push('/admin/attribution')}
                    variant="outline"
                    size="sm"
                  >
