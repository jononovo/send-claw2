...
import { ArrowRight, Bot, User, Copy, Check, Inbox, Mail, Moon, Sun } from "lucide-react";
...
export default function LobsterLanding() {
  ...
  const handleReserve = async () => {
    ...
    // For now, redirect to registration with the handle pre-filled
