...
export default function LandingSimple3() {
          ...
          <div className="container mx-auto px-4 relative z-10 grid lg:grid-cols-2 gap-12 items-center py-20">
            ...
            <div className="flex flex-col gap-8 max-w-2xl">
              ...
              <div className="flex flex-col gap-4 w-full max-w-md mt-4">
                ...
                <div className="group flex flex-wrap justify-center gap-4 text-gray-500 text-sm px-6 py-4 -mt-2 rounded-lg hover:text-gray-900 dark:hover:text-white hover:scale-105 transition-all duration-200">
