                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                      {[
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 text-sm bg-transparent border border-border hover:border-accent text-muted-foreground hover:text-accent rounded-lg transition-colors"
