          ...
          <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center py-20">
            ...
            <div className="flex flex-col gap-8 max-w-xl">
              ...
              <div className="flex flex-col gap-4 w-full max-w-md mt-4">
                ...
                >
                  <span 
                    className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 ease-in rounded-xl group-hover:animate-[shimmer_4s_ease-in-out_infinite]"
                    style={{ 
