              ...
              <div className="flex flex-col gap-4 w-full max-w-md mt-4">
                ...
                >
                  ...
                  <span className="relative z-10 flex items-center">
                    ...
                    <span className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:animate-[text-swap-in_3s_ease-in-out_forwards] text-white">You've Got This! Let's go</span>
